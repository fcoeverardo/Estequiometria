...
public class Interaction4Activity extends InteractionAcitivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUpToolbar(getString(R.string.int4Name));
        ...
        tvExp.setText(HtmlCompat.fromHtml(getString(R.string.tvExp4)));
